...
**So, you want a build startup. Do you have a solid startup idea?**
...
I crated a Google spreadsheet [spreadsheet](https://docs.google.com/spreadsheets/d/1cj0b4N2undRaoT1taHOldA6Bua1m0J8rSE7KUbN63mY/edit#gid=0) that you can copy and use for the valuation.
...
If you want to know how to get and manage the feedback from your customers, you might want to check out [this article](https://lunadio.netlify.com/efficient-feedback-management-as-a-growth-tactic "Efficient feedback management as a growth tactic").
