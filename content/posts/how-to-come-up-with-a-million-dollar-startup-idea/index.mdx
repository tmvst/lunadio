...
But, what project idea should it be? **I needed a way to sum up all ideas I have across fields and choose the best one.** I did a workshop inspired by [https://twitter.com/get_eo](Othmane) with my friends. The main goal was to pick potential ideas that we/I can build.
